...
lista_personas: list = [{"dni": "47259697", "nombres": "Noe Wilber", "apellidos": "Tipo Mamani", "direccion": "tacna", "telefono": "997124032"},
                        ...
                        {"dni": "47259610", "nombres": "Andres", "apellidos": "Tipo Mamani",
...
lista_productos: list = [{"codigo": "01", "nombre": "blusa", "precio": 35.00, "marca": "storeliz"},
                         {"codigo": "02", "nombre": "pantalon",
                             "precio": 35.00, "marca": "storeliz"},
                         {"codigo": "03", "nombre": "camisa",
                             "precio": 35.00, "marca": "storeliz"},
                         {"codigo": "04", "nombre": "vestido", "precio": 35.00, "marca": "storeliz"}]
...
def main():
    ...
    canvas.drawString(30,750,'TIENDA DE ROPA')
    canvas.drawString(30,735,'STORELIZ')
    canvas.drawString(500,750,"21/12/2022")
    canvas.line(480,747,580,747)
    canvas.drawString(275,725,'MONTO PAGADO:')
    canvas.drawString(500,725,"$35.00")
